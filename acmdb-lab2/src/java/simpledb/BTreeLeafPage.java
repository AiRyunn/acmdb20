...
public class BTreeLeafPage extends BTreePage {
    ...
    // public void _check() {
    //     for (Iterator<Tuple> it = this.iterator(); it.hasNext();) {
    //         Tuple tuple = it.next();
    //         assert tuple.getRecordId().getPageId().pageNumber() == getId().pageNumber();
    //     }
    //     for (Iterator<Tuple> it = this.reverseIterator(); it.hasNext();) {
    //         Tuple tuple = it.next();
    //         assert tuple.getRecordId().getPageId().pageNumber() == getId().pageNumber();
    //     }
    // }
