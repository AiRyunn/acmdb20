...
public class InsertTest extends TestUtil.CreateHeapFile {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.scan1 = TestUtil.createTupleList(2, new int[] { 1, 2, 1, 4, 1, 6, 3, 2, 3, 4, 3, 6, 5, 7 });
    ...
    public void getNext() throws Exception {
        Insert op = new Insert(tid, scan1, empty.getId());
        op.open();
        assertTrue(TestUtil.compareTuples(Utility.getHeapTuple(7, 1), // the length of scan1
                op.next()));
