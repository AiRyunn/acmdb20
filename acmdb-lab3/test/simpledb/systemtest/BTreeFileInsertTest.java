...
public class BTreeFileInsertTest extends SimpleDbTestBase {
    ...
    public void testSplitLeafPage() throws Exception {
        ...
        BTreeFile onePageFile = BTreeUtility.createRandomBTreeFile(2, 502, null, null, 0);
        ...
        BTreeInternalPage root = (BTreeInternalPage) Database.getBufferPool().getPage(tid, rootId,
                Permissions.READ_ONLY);
    ...
    public void testSplitRootPage() throws Exception {
        ...
        // 504 * 502 = 253008
        BTreeFile bigFile = BTreeUtility.createRandomBTreeFile(2, 253008, null, null, 0);
    ...
    public void testSplitInternalPage() throws Exception {
        ...
        // 125*2*124 = 31000)
        BTreeFile bigFile = BTreeUtility.createRandomBTreeFile(2, 31000, null, null, 0);
