...
public class BTreeFileDeleteTest extends SimpleDbTestBase {
    ...
    public void testStealFromLeftLeafPage() throws Exception {
        ...
        BTreeLeafPage page = BTreeUtility.createRandomLeafPage(pageId, 2, keyField,
                BTreeUtility.getNumTuplesPerPage(2) / 2 - 1, BTreeUtility.MAX_RAND_VALUE / 2,
    ...
    public void testStealFromRightLeafPage() throws Exception {
        ...
        BTreeLeafPage sibling = BTreeUtility.createRandomLeafPage(siblingId, 2, keyField,
                BTreeUtility.MAX_RAND_VALUE / 2, BTreeUtility.MAX_RAND_VALUE);
    ...
    public void testMergeLeafPages() throws Exception {
        ...
        BTreeInternalPage parent = BTreeUtility.createRandomInternalPage(parentId, keyField, BTreePageId.LEAF,
                BTreeUtility.MAX_RAND_VALUE / 2, BTreeUtility.MAX_RAND_VALUE, 2);
    ...
    public void testStealFromLeftInternalPage() throws Exception {
        ...
        BTreeInternalPage page = BTreeUtility.createRandomInternalPage(pageId, keyField, BTreePageId.LEAF,
                ...
                5 + entriesPerPage);
        BTreeInternalPage sibling = BTreeUtility.createRandomInternalPage(siblingId, keyField, BTreePageId.LEAF, 0,
                BTreeUtility.MAX_RAND_VALUE / 2, 4);
        ...
        assertTrue(
                sibling.reverseIterator().next().getKey().compare(Op.LESS_THAN_OR_EQ, page.iterator().next().getKey()));

        // is the parent key reasonable?
        assertTrue(parent.iterator().next().getKey().compare(Op.LESS_THAN_OR_EQ, page.iterator().next().getKey()));
        assertTrue(parent.iterator().next().getKey().compare(Op.GREATER_THAN_OR_EQ,
                sibling.reverseIterator().next().getKey()));
    ...
    public void testStealFromRightInternalPage() throws Exception {
        ...
        BTreeInternalPage sibling = BTreeUtility.createRandomInternalPage(siblingId, keyField, BTreePageId.LEAF,
                BTreeUtility.MAX_RAND_VALUE / 2, BTreeUtility.MAX_RAND_VALUE, 4 + entriesPerPage / 2);
        ...
        // are the keys in the left page less than the keys in the right page?
        assertTrue(
                page.reverseIterator().next().getKey().compare(Op.LESS_THAN_OR_EQ, sibling.iterator().next().getKey()));
